...
data_arg.add_argument('--dataset', type=str, default='cufs', choices=['cufs'])
...
data_arg.add_argument('--batch_size_gen', type=int, default=100)


# Training / test parameters
train_arg = add_argument_group('Training')
train_arg.add_argument('--is_train', type=str2bool, default=False)
train_arg.add_argument('--is_gen', type=str2bool, default=True)
...
misc_arg.add_argument('--load_path', type=str, default='cufs_Q1_2')
...
misc_arg.add_argument('--question', type=str, default='Q1_3')
