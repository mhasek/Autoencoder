...
class Trainer(object):
  ...
  def build_model(self):
    ...
    self.G_z, self.G_var = generator(z, self.batch_size, 
  ...
  def build_gen_eval_model(self):
    ...
    self.G_z_test, var = generator(z_test, self.batch_size_eval, 
      is_train=False, reuse=True)

    G_z_test = self.G_z_test

    self.D_G_z_test, var = discriminator(G_z_test, self.batch_size_eval, 
      is_train=False, reuse=True)
